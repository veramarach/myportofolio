...
const Hero :React.FC= () => {
  return (
    ...
    <h2 className=' font-extrabold tablet:relative tablet:w-[350px]  text-6xl tablet:text-5xl  bg-gradient-to-r  from-blue-300 via-pink-400 to-indigo-300 flex   text-transparent bg-clip-text  animate-slide-down '>
            Hello,i'm Vera
